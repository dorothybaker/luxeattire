...
async function getData() {
  const query = `*[_type == 'product' && listing->name == 'featured'][0...5] | order(_createdAt desc) {
  ...
  return (
    <div className="max-w-7xl mx-auto w-full p-4">
      <div className="flex flex-col">
        <h1 className="sm:text-4xl text-3xl">Featured products</h1>
        <span className="text-sm text-gray-500">
          Our cullated collection of luxuriness
        </span>
      </div>
      {loading ? (
        <CardSkeleton />
